...
/// Converts escaped special characters to their original characters.
...
impl<'cache> PatternsCache {
    ...
    pub fn get<'compiled_pattern, 'string_pattern>(
        &'cache mut self,
        pattern: &'string_pattern str,
